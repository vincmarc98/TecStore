...
<%
	...
	if (userlog == false || adminlog == true || operatorlog==true) {
...
<body>
	...
	<div align="center">
		...
		<h3>
			Hai appena inserito un nuovo ordine.
		</h3>
		<br>
		<h1>
			Clicca <a style="color: #18BC9C" href="OrdersOperations?action=searchByUser">qui</a> per visualizzare i tuoi ordini.
		</h1>
	</div>
</body>
</html>