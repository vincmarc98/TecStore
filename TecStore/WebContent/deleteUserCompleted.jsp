...
<%
	...
	Boolean assistenzalog = (Boolean) request.getSession().getAttribute("assistenzalog");
...
<body>
	...
	<!-- Navigation -->
	<%if(userlog==true && adminlog!=true && operatorlog!=true && assistenzalog!=true) {%>
	...
	<div align="center">
		...
		<h2>
			Hai appena cancellato l'utente.
		</h2>
		<br>
		<h1>
			Clicca <a style="color: #18BC9C" href="UsersOpAdmin?action=showlist">qui</a> per tornare alla gestione degli utenti.
		</h1>
		</div>
</body>
</html>